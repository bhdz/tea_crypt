...
TeaKey.prototype.shuffle = function(kookies) {
    ...
    var shuffle = 0xA1B6325788901343; // this scrambles the _chi__pper by doing stupid calculations.
    ...
    // izigravame sega sketch scenka s
    
    
    
	var a = cookies[i]; // oi! b1tch! oi! oi! 
	//ttingkoating
