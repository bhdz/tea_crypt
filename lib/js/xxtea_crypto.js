...
window.xxtea_crypto = (function () {
    ...
    var util = {
        ...
        InitializeBlock: function (block, block_size, cleartext, from_position, padding) {
            var is_lastblock = false, r = 0, p, alpha_code = "", code_point = "";
                    /*
                    {{ snatched from? StringToBlocks2, therefore? StringToBlocks2 it is... }}
                ...
                if ((i) % block_size == 0) {
                    ...
                    */
                    if (last_block == false) {
                        ...
                        result.push(block); 
                        break; // LOL? yes! This is the powa of js. ::Functional !and ::Ubiqui-tus; liek C for the browser... NO OPeration {line} ... self-reflexion
                    }
